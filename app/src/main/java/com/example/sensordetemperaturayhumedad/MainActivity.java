package com.example.sensordetemperaturayhumedad;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private Boolean temperaturaDisponoble;
